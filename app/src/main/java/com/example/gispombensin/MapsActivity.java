...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String[] nama,alamat,jambuka,gambar,id;
    int jumdata;
    ...
    private void getlokasi(){
        String url = "https://stationgas.000webhostapp.com/stationgas.php";
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for (int i = 0; i < jumdata; i++) {
                            try {
                                ...
                                jambuka[i] = data.getString("jam_buka");
                                ...
                                for(int i=0;i<jumdata;i++){
                                    if (marker.getTitle().equals(nama [i])) {
                                        if (MarkerD[i]) {
                                            ...
                                            Toast pesan = Toast.makeText(MapsActivity.this, "silahkan click 1x lagi untuk detail", Toast.LENGTH_LONG);
